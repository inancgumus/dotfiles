...
installBrewCaskPackage 'font-cascadia-code'
installBrewCaskPackage 'font-cascadia-code-pl'
installBrewCaskPackage 'font-hasklig'
installBrewCaskPackage 'font-hasklug-nerd-font'
